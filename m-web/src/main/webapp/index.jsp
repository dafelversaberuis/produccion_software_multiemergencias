...
<%
                ...
                %>
                 <li><a href="#seccion<%=s.getSeccion() %>" class="nav-link"><%=s.getTitulo().trim() %></a></li>
                  ...
                  <%} } %>
				<li><a href="#galeriadefotos" class="nav-link">*Galería</a></li>
...
<div  style="font-size:14px; text-align : justify;">
   ...
   1. Multiemergencias S.A.S. recolectará, usará y tratara datos personales, conforme la Política de Tratamiento de Datos Personales que ha implementado y actuará como responsable del tratamiento de datos personales de los cuales soy titular.
 <br/>
 <br/>
2. Los datos personales que se utilizarán son: Nombres y apellidos, documento de identidad, dirección de correo electrónico.
 <br/>
 <br/>
3. Los datos personales recogidos se utilizan con el propósito de (i) Generar certificaciones de los cursos/diplomados/capacitaciones sobre los cuales se ha capacitado. (ii)Informar sobre nuestras promociones, ofertas, novedades y servicios sobre los distintos cursos; (iii) Dar cumplimiento a obligaciones contraídas con nuestros clientes (iv) Evaluar la calidad del servicio (vii) Gestionar tareas básicas de administración.
 <br/>
 <br/>
4. Mis derechos como titular de los datos son los previstos en la Constitución y la ley 1581 de 2012, especialmente el derecho a conocer, actualizar, rectificar y suprimir mi información personal, así como el derecho a revocar el consentimiento otorgado para el tratamiento de datos personales. Los derechos pueden ser ejercidos a través de canales como líneas telefónicas, correo electrónico, página web, redes sociales.
 <br/>
 <br/>
5. Multiemergencias S.A.S. garantiza la confidencialidad, libertad, seguridad, veracidad, transparencia, acceso y circulación restringida de mis Teniendo en cuenta lo anterior, autorizo de manera voluntaria, previa, explícita, informada e inequívoca a Multiemergencias S.A.S. para tratar mis datos personales. La información obtenida para el Tratamiento de mis datos personales la he suministrado de forma voluntaria y es verídica.
