...
<p class="Estilo4">&nbsp;</p>
<p class="Estilo4">&nbsp;</p>
<p class="Estilo4">Busque la foto que desea compartir en el repositorio, luego haga clic en aceptar (Sólo formato jpg):</p>
<form action="recibirFoto.jsp?tu=2&us=<%=us%>" method="post" enctype="multipart/form-data" name="frm_cargar">
        <p>
