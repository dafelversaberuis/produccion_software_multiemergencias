			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h3>Cursos o tipos de certificados</h3>

				
<br/><br/>
<a href="#" onclick="window.open('/m-web/crearCurso.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=350'); return false;" style="text-decoration:none">Crear nuevo curso o tipo de certificado</a><br><br>
